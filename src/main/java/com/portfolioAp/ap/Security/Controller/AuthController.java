...
import com.portfolioAp.ap.Security.Dto.LoginUsuario;
import com.portfolioAp.ap.Security.Dto.NuevoUsuario;
import com.portfolioAp.ap.Security.Entity.Rol;
import com.portfolioAp.ap.Security.Entity.Usuario;
import com.portfolioAp.ap.Security.Enums.RolNombre;
import com.portfolioAp.ap.Security.Service.RolService;
import com.portfolioAp.ap.Security.Service.UsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<JwtDto> login(@Valid @RequestBody LoginUsuario loginUsuario, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) 
            return new ResponseEntity(new Mensaje("Campos mal implementados"), HttpStatus.BAD_REQUEST);
